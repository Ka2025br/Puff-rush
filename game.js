...
const screens=["home","map","intro","complete","gameover","premium","ending","profile","ranking"];
...
function persist(){localStorage.pr375finalbest=Math.max(best,score);localStorage.pr375finalbank=bank;localStorage.pr375finalunlock=unlocked;localStorage.pr375finalstars=JSON.stringify(stars);localStorage.pr375premium="0";localStorage.pr375sound=soundOn?"1":"0";best=Math.max(best,score);saveBoard()}
function homeStats(){}
